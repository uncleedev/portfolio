          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
            <div className="space-y-8">
              <div className="space-y-4">
                <h2 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white leading-tight">Jhon Brian Arce</h2>
                <h3 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-accent">
                  Aspiring Software Engineer
                </h3>
                <p className="text-lg sm:text-xl text-gray-300 max-w-2xl leading-relaxed">
                  I am a 4th year college student with a passion for development and a goal of becoming a succesfull Software Engineer.
                </p>
              </div>

              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" className="bg-[#4A7C7A] hover:bg-[#4A7C7A]/80 text-white px-8 py-3 text-lg"
              ...
              <div className="flex space-x-6">
                {socialLinks.map((link, index) => (
                  <Link key={index} href={link.href} className="text-gray-400 hover:text-[#D4AF37] transition-colors">
                    {link.icon}
                  </Link>
                ))}
              </div>
